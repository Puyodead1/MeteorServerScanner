...
import me.puyodead1.serverscanner.ssapi.requests.WhereisRequest;
import me.puyodead1.serverscanner.ssapi.responses.WhereisResponse;
        ...
        add(theme.button("Find Player")).expandX().widget().action = () -> {
            ...
            for (WhereisResponse.Record server : data) {
                ...
                addServerButton.action = () -> {
                    ServerInfo info = new ServerInfo("ServerScanner " + serverIP + " (Player: " + playerName + ")", serverIP, ServerInfo.ServerType.OTHER);
